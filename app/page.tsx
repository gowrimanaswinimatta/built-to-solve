  ...
  return (
    <>
      ...
      <main>
        ...
        <Section><Container><SectionHeading eyebrow="Experience journey" title="From operational analytics to enterprise systems and independent product development." /><div className="flex flex-wrap gap-3">{journey.map((item) => <Badge key={item}>{item}</Badge>)}</div></Container></Section>
