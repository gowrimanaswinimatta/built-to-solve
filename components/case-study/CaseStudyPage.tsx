        ...
        <Section>
          <Container>
            <SectionHeading
              ...
              title="From complexity to an operating layer people can trust."
            />
            <ol className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
              {product.workflow.map((step, i) => (
                ...
                >
                  <span className="text-sm text-emerald-300">0{i + 1}</span>
        ...
        <Section>
          <Container>
            <div className="grid gap-6 lg:grid-cols-2">
              <List title="Constraints" items={product.constraints} />
              <List title="Approach" items={product.approach} />
              <List title="Key decisions" items={product.decisions} />
              <List title="Lessons" items={product.lessons} />
            </div>
          </Container>
        </Section>
        <Section>
            ...
            <Card className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <Link
                  ...
                  className="mt-2 block text-2xl font-semibold hover:text-emerald-300"
                >
                  {next.title}
                </Link>
              </div>
              <Button href="/contact">Discuss a system</Button>
            </Card>
          </Container>
        </Section>
      </main>
